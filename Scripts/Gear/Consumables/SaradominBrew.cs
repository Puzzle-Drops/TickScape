...
public class SaradominBrew : Potion
{
    ...
    public override void Drink(Player player)
    {
        ...
        player.currentStats.defence = Mathf.Max(1,
            Mathf.Min(player.currentStats.defence, player.stats.defence + maxDefenceBoost));
        ...
        Debug.Log($"[POTION] Drank brew: Healed {healAmount}, DEF +{defenceBoost}, combat stats drained");
    }
}