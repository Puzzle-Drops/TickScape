...
public static class UIFonts
{
    ...
    /// Shadow offset scales with UI scale for consistent appearance.
    /// </summary>
    public static void DrawShadowedText(Rect rect, string text, GUIStyle style, float scale)
    {
        // Calculate scaled shadow offset
        float shadowOffset = 1 * scale;

        // Create shadow style (same as main style but black)
