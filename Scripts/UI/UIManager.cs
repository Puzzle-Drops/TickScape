...
public class UIManager : MonoBehaviour
{
    ...
    private void InitializePanels()
    {
        ...
        panels.Add(new EmptyPanel());           // Empty - Tab 8
        panels.Add(new EmptyPanel());           // Empty - Tab 9
        panels.Add(new EmptyPanel());           // Empty - Tab 10
        panels.Add(new EmptyPanel());           // Empty - Tab 11
        panels.Add(new EmptyPanel());           // Empty - Tab 12
        panels.Add(new EmptyPanel());           // Empty - Tab 13
