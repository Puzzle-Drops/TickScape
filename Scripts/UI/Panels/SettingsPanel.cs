...
public class SettingsPanel : BasePanel
{
    ...
    /// Position: Y=90 (moved down 20px from original 70)
    /// </summary>
    private void DrawVolumeSlider(float panelX, float panelY, float scale)
    {
        float startY = 90; // Was 70, now 90 (+20px)
    ...
    /// Position: Y=135 (moved down 10px from original 125)
    /// </summary>
    private void DrawUIScaleSlider(float panelX, float panelY, float scale)
    {
        float startY = 135; // Was 125, now 135 (+10px)
    ...
    {
        float startY = 234; // Unchanged position
    ...
    public override void OnPanelClickDown(float relativeX, float relativeY)
    {
        ...
        // Check Volume slider click (Y=110-125, moved from 90-105)
        if (relativeX > 75 && relativeX < 185 && relativeY > 110 && relativeY < 125)
        {
        ...
        // Check UI Scale slider click (Y=155-170, moved from 145-160)
        if (relativeX > 75 && relativeX < 185 && relativeY > 155 && relativeY < 170)
        {
        ...
        // Check Ping slider click (Y=200-215, unchanged)
    ...
    public override void OnCursorMoved(float relativeX, float relativeY)
    {
        ...
        {
            // Check if mouse is over Volume slider area (Y=90-125, moved from 70-105)
            if (relativeX > 20 && relativeX < 185 && relativeY > 90 && relativeY < 125)
            {
            ...
            // Check if mouse is over UI Scale slider area (Y=135-170, moved from 125-160)
            else if (relativeX > 20 && relativeX < 185 && relativeY > 135 && relativeY < 170)
            {
            ...
            // Check if mouse is over Ping slider area (Y=180-215, unchanged)
