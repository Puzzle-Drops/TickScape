...
public class CombatPanel : BasePanel
{
    ...
    private Texture2D specialAttackBarHighlightedTexture;
    ...
    public override void Initialize()
    {
        ...
        specialAttackBarHighlightedTexture = TextureLoader.LoadTexture(
            "UI/Elements/special_attack_bar_highlighted",
            new Color(0.5f, 0.4f, 0.3f),
            150, 24
        );
    ...
    private void DrawAutoRetaliateButton(float x, float y, float scale, bool isActive)
    {
        ...
        UIFonts.DrawShadowedText(new Rect(x, y + 11 * scale, 147 * scale, 20), "Auto Retaliate", buttonTextStyle, scale);
    }
    ...
    private void DrawSpecialAttackBar(float x, float y, float scale, Player player)
    {
        ...
        // Use highlighted texture if special attack is enabled
        Texture2D barTexture = player.useSpecialAttack
            ? specialAttackBarHighlightedTexture
            : specialAttackBarTexture;
