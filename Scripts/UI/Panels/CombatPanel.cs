...
public class CombatPanel : BasePanel
{
    ...
    public override void Initialize()
    {
        ...
        weaponNameStyle.fontSize = 21;
        weaponNameStyle.normal.textColor = new Color(1f, 0.6f, 0f); // Orange
        weaponNameStyle.alignment = TextAnchor.MiddleCenter;

        weaponNameStyleShadow = new GUIStyle(weaponNameStyle);
        weaponNameStyleShadow.normal.textColor = Color.black;

        buttonTextStyle = new GUIStyle();
        buttonTextStyle.fontSize = 16;
        buttonTextStyle.normal.textColor = new Color(1f, 0.6f, 0f);
        buttonTextStyle.alignment = TextAnchor.MiddleCenter;

        buttonTextStyleShadow = new GUIStyle(buttonTextStyle);
        buttonTextStyleShadow.normal.textColor = Color.black;

        specTextStyle = new GUIStyle();
        specTextStyle.fontSize = 16;
        specTextStyle.normal.textColor = Color.black;
        specTextStyle.alignment = TextAnchor.MiddleCenter;
    }
    ...
    public override void DrawPanel(float x, float y, float scale)
    {
        ...
        GUI.Label(new Rect(x + 101 * scale, y + 31 * scale, 100, 20), weaponName, weaponNameStyleShadow);
        GUI.Label(new Rect(x + 100 * scale, y + 30 * scale, 100, 20), weaponName, weaponNameStyle);
    ...
    private void DrawAttackStyleButton(float x, float y, float scale, AttackStyle style, bool isSelected)
    {
        ...
        GUI.Label(new Rect(x + 36 * scale, y + 41 * scale, 70 * scale, 20), styleName, buttonTextStyleShadow);
        GUI.Label(new Rect(x + 35 * scale, y + 40 * scale, 70 * scale, 20), styleName, buttonTextStyle);
    }
    ...
    private void DrawAutoRetaliateButton(float x, float y, float scale, bool isActive)
    {
        ...
        // Draw text
        GUI.Label(new Rect(x + 74 * scale, y + 28 * scale, 147 * scale, 20), "Auto Retaliate", buttonTextStyleShadow);
        GUI.Label(new Rect(x + 73 * scale, y + 27 * scale, 147 * scale, 20), "Auto Retaliate", buttonTextStyle);
    }
    ...
    private void DrawSpecialAttackBar(float x, float y, float scale, Player player)
    {
        ...
        GUI.Label(new Rect(x + 75 * scale, y + 17 * scale, 150 * scale, 20), specText, specTextStyle);
    }
