...
public class CombatPanel : BasePanel
{
    ...
    public override void DrawPanel(float x, float y, float scale)
    {
        ...
        GUI.Label(new Rect(x + 65 * scale, y + 21 * scale, 100, 20), weaponName, weaponNameStyleShadow);
        GUI.Label(new Rect(x + 64 * scale, y + 20 * scale, 100, 20), weaponName, weaponNameStyle);
    ...
    private void DrawAttackStyleButton(float x, float y, float scale, AttackStyle style, bool isSelected)
    {
        ...
        GUI.Label(new Rect(x * scale, y + 15 * scale, 70 * scale, 20), styleName, buttonTextStyleShadow);
        GUI.Label(new Rect(x - 1 * scale, y + 14 * scale, 70 * scale, 20), styleName, buttonTextStyle);
    }
    ...
    private void DrawAutoRetaliateButton(float x, float y, float scale, bool isActive)
    {
        ...
        // Draw text
        GUI.Label(new Rect(x + 16 * scale, y + 12 * scale, 147 * scale, 20), "Auto Retaliate", buttonTextStyleShadow);
        GUI.Label(new Rect(x + 15 * scale, y + 11 * scale, 147 * scale, 20), "Auto Retaliate", buttonTextStyle);
    }
